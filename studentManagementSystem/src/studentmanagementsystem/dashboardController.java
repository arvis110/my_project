    ...
    public void addStudentsAdd() {
        ...
        try {
            ...
            if (addStudents_studentNum.getText().isEmpty()
                ...
                // studentnumber burtgegdsn esehiig shalgah
                ...
                if (result.next()) {
                    ...
                    // table iin datag update hiih
                    addStudentsShowListData();
                    // textfield talbaruudiig clear hiih
                    addStudentsClear();
                }
            }
